    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                modifier = Modifier.padding(20.dp)   // DIBENERIN
            ) {
                Icon(
                    imageVector = Icons.Default.Add,
                    contentDescription = "Tambah Siswa"   // DIBENERIN
                )
            }
        }
    ) { innerPadding ->
...
fun BodyHome(
    ...
    Column(
        ...
        if (itemSiswa.isEmpty()) {
            Text(
                text = "Tidak ada data Siswa. Tap + untuk menambah data",   // DIBENERIN
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Spacer(modifier = Modifier.weight(1f))   // DIBENERIN
                Icon(
